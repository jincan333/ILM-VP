...
def main():
    ...
    set_seed(args.seed)
    # Save Path
    save_path = os.path.join(args.save_dir, args.network, args.dataset, args.experiment_name, 'VP'+str(args.prompt_method), 'FF'+str(args.is_finetune), 'LP'+str(args.is_linear_head), 
