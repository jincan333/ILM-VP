...
def main():
    ...
    parser.add_argument('--save_dir', help='The directory used to save the trained models', default='results/sparsity/grasp_flm_no_finetune', type=str)
    ##
    ...
    parser.add_argument('--density', type=float, default=0.32768, help='The density of the overall sparse network.')
