...
parser.add_argument('--label_mapping_mode', type=str, default='ilm', help='rlm, flm, ilm')
...
parser.add_argument('--save_dir', help='The directory used to save the trained models', default='results/sparsity/imp_ilm_no_finetune', type=str)
...
parser.add_argument('--prune_method', default='imp', type=str, help='imp, omp, grasp')
...
acc_list = []
for i in range(10):
    checkpoint_path = f'{args.save_dir}/{i}checkpoint.pth.tar'
    ...
    if 'imp' in args.prune_method:
        if i>0 and start_state>0:
