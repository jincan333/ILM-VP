...
def main():    
    ...
    parser.add_argument('--dataset', default="stanfordcars", choices=['cifar10', 'cifar100', 'flowers102', 'dtd', 'food101', 'oxfordpets', 'stanfordcars', 'sun397', 'tiny_imagenet', 'imagenet'])
