...
def main():    
    ...
    parser.add_argument('--ff_scheduler', default='0.01', help='decreasing strategy.', choices=['cosine', 'multistep'])
    ...
    parser.add_argument('--density_list', default='1,0.10,0.01,0.001', type=str, help='density list(1-sparsity), choose from 1,0.50,0.40,0.30,0.20,0.10,0.05,0.01,0.001')
