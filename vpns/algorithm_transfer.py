...
def main():    
    ...
    parser.add_argument('--weight_vp_lr', default=0.001, type=float, help='initial learning rate')
...
def train(train_loader, val_loader, network, epoch, label_mapping, visual_prompt, mask, weight_optimizer, vp_optimizer, weight_scheduler, vp_scheduler):
