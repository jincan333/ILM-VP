...
experiment_name='vpns_input_size'
...
input_sizes=(32 64 96 128 160 192)
gpus=(7 6 5 4 3 2)
            ...
            for l in ${!prune_methods[@]};do
                for m in ${!seeds[@]};do 
                    for n in ${!input_sizes[@]};do      
                        log_filename=${foler_name}/${input_sizes[n]}_${networks[j]}_${datasets[i]}_${prune_modes[k]}_${prune_methods[l]}_${seeds[m]}_${weight_optimizer}_${weight_lr}_${weight_vp_optimizer}_${weight_vp_lr}_${score_optimizer}_${score_lr}_${score_vp_optimizer}_${score_vp_lr}.log
