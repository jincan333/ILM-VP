...
experiment_name='vpns_prompt_method'
            ...
            for l in ${!prune_methods[@]};do
                for m in ${!seeds[@]};do 
                    for n in ${!prompt_methods[@]};do      
                        log_filename=${foler_name}/${prompt_methods[n]}_${networks[j]}_${datasets[i]}_${prune_modes[k]}_${prune_methods[l]}_${seeds[m]}_${weight_optimizer}_${weight_lr}_${weight_vp_optimizer}_${weight_vp_lr}_${score_optimizer}_${score_lr}_${score_vp_optimizer}_${score_vp_lr}.log
